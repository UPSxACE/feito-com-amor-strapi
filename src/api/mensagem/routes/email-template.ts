export default function emailTemplate(
    ...
    <tbody style="line-height: inherit">
      ...
      >
        ...
        >
          ...
          >
            <p style="line-height: 140%; margin: 0">
              <strong style="line-height: inherit">Telefone:</strong> ${phone}
            </p>
          </div>
        </td>
      </tr>
  ...
  const emailText = `Novo pedido de contacto. De: ${name}. Telefone: ${phone}. Email: ${email}. Assunto: ${subject}. Mensagem: ${message}`;
