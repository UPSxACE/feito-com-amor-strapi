  ...
  config: {
    ...
    translations: {
      ...
      "pt-BR": {
        ...
        "upload.modal.folder.create.title": "Adicionar pasta",
        "upload.modal.folder.edit.title": "Editar pasta",
        "upload.form.input.label.folder-name": "Nome",
        "upload.modal.folder.create.submit": "Criar",
        "upload.modal.folder.create.cancel": "Cancelar",
        "upload.modal.folder.create.delete": "Apagar",
        "Button.cancel": "Cancelar",
        "app.components.Button.cancel": "Cancelar",
        "upload.app.components.Button.cancel": "Cancelar",
        "global.save": "Guardar",
        save: "Guardar",
        "content-manager.containers.Edit.save": "Guardar",
        "list.assets.to-upload":
          "{number, plural, =0 {Nenhum arquiv} one {1 arquivo} other {# arquivos}} prontos para upload",
      },
    },
  },
