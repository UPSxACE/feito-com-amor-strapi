...
export interface ApiPrecoPreco extends Struct.CollectionTypeSchema {
  collectionName: 'precos';
  info: {
    singularName: 'preco';
    pluralName: 'precos';
    displayName: 'Pre\u00E7os';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::preco.preco'>;
  };
}
